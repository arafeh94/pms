...
<?= $form->field($model, 'date_payment')->widget(DatePicker::className(), \app\components\Extensions::picker()) ?>
<?= $form->field($model, 'crv_ref')->textInput() ?>
<?= $form->field($model, 'due_date')->widget(DatePicker::className(), \app\components\Extensions::picker()) ?>
<?= $form->field($model, 'inv_ref')->textInput(['placeholder' => 'Evaluated After Creation']) ?>
<?= $form->field($model, 'inv_date')->widget(DatePicker::className(), \app\components\Extensions::picker()) ?>
